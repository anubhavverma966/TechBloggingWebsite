<%-- 
    Document   : login_page
    Created on : 28-Dec-2022, 10:26:37 pm
    Author     : hp
--%>
...
<head>
	...
	<style>
		...
		.banner-background1{
			clip-path: polygon(30% 0%, 70% 0%, 100% 0, 100% 95%, 65% 98%, 24% 96%, 0 98%, 0 0);
		}
	</style>
</head>
<body>
	...
	<main class= "d-flex align-items-center primary-color banner-background1" style= "height: 70vh">
		<div class= "container">
			<div class="row">
